...
def create_parser():
    ...
    parser.add_argument('-sem', '--send-email',help='Whether or not to send email',default=False)    
    parser.add_argument('-up', '--upload',help='Whether or not to upload lists to AWS',default=False)    
