...
|	SA	|	Sensitive/Conservation	||<ol><li> xxxxx</li> <li>xxxxxx</li> <li>Data processed including: </li> <li>Creating additional DWC columns for known values</li> </ul></ol> |
