...
| --------- | ------------------|--------------|--------------------|
  |	ACT	|	Sensitive	|Webpage/MS Excel|<ol><li>Webpage has link to MS Excel file</li><li>Downloaded MS Excel Spreadsheet </li><li>Saved as CSV</li><li>Data processed using text editor Vim/Regex: </li><ul><li>Adding commas to separate columns</li><li>Splitting single species name column into 2 separate columns for *vernacularName* and *scientificName*</li><li>Remove brackets from *vernacularName*</li><li>Created additional DWC columns for known values</li></ul></ol> |
...
|	VIC	|	Sensitive	|Webpage	|<ol><li> xxxxx</li> <li>xxxxxx</li> <li>Data processed including: </li> <li>Creating additional DWC columns for known values</li> </ul></ol> |
...
|	VWA|	Sensitive	|Webpage	|<ol><li> xxxxx</li> <li>xxxxxx</li> <li>Data processed including: </li> <li>Creating additional DWC columns for known values</li> </ul></ol> |
